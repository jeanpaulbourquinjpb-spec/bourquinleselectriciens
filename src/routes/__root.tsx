...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "bourquin les électriciens — Genève" },
      { name: "description", content: "Entreprise d'électricité générale à Genève depuis 1968. Électricité, télécom, sécurité, dépannage." },
      { name: "author", content: "Bourquin Jean-Yves SA" },
      ...
      { property: "og:image", content: "https://bourquinelectricite.ch/assets/logo-bourquin-BneznNWU.png" },
      { name: "twitter:image", content: "https://bourquinelectricite.ch/assets/logo-bourquin-BneznNWU.png" },
    ...
    links: [
      ...
      { rel: "dns-prefetch", href: "https://otfbjmwkdduxcqupmvni.supabase.co" },
      { rel: "preconnect", href: "https://otfbjmwkdduxcqupmvni.supabase.co" },
      {
        rel: "preload",
